...
from .models import MLProject, MLPipeline
...
class TrainView(InstanceSpecificView):
    template_name = "wagtailadmin/modeladmin/mlproject/train.html"
...
class PredictView(InstanceSpecificView):
    template_name = "wagtailadmin/modeladmin/mlproject/predict.html"
...
class MLProjectAdmin(ModelAdmin):
    ...
    inspect_template_name = "wagtailadmin/modeladmin/mlproject/inspect.html"
...
class MLPipelineAdmin(ModelAdmin):
...
class MLGroup(ModelAdminGroup):
    ...
    items = (MLProjectAdmin, MLPipelineAdmin)
