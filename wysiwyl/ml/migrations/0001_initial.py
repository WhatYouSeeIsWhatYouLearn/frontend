    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('train_proportion', models.FloatField(default=0.8, help_text='Proportion of training data that should be used for training (complement will be used for testing)', validators=[ml.models.validate_proportion])),
                ...
                ('pipeline_object', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mlproject_pipeline', to='ml.mlpipeline')),
